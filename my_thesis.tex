...
\part{MRxMHD and SPEC}
%\include{main/ch2_figures_tables}
\subfile{main/ch2_3DEquilibria}
\subfile{main/ch3_SPEC}
\cleardoublepage

\part{Equilibrium $\beta$-limits}
\subfile{main/ch4_integrability}
\subfile{main/ch5_beta_limit}
\cleardoublepage

\part{Optimization}
\subfile{main/ch6_optimization}
